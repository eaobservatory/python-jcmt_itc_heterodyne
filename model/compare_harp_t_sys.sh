...
python make_comparison.py -v --dir harp_combined_median --outdir harp_combined_median

python plot_comparison.py -v --plot harp_combined_median/tsys_comparison.pdf \
